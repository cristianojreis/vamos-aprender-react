...
export default class DavMenuPrincipal extends Component {
    renderMenu(menuItens) {
        const rederedMenuItens = menuItens.map((menuItem) => <li key={menuItem.IdMenu} className="dav-menu-ul-li"><a className="dav-menu-ul-li-a" href={menuItem.Link}>{menuItem.Titulo}</a></li>);
        return <ul className="dav-menu-ul">{rederedMenuItens}</ul>
    }
    ...
    render() {
        ...
        // return (
        //     <div className="dav-menu-div">
        //         {this.renderMenu(this.props.menuLista)}
        //     </div>
        // );
    }
}

DavMenuPrincipal.PropTypes = {
