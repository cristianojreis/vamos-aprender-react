...
export default class DavConteudo extends Component {
    render () {
                ...
                <div className="row">
                    ...
                    <div className="box box-success">
                        ...
                        <div className="row">
                            ...
                            <div className="pad box-pane-right bg-green" style={{'min-height': '280px'}}>
                    ...
                    <div className="row">
                        ...
                        <div className="box box-warning direct-chat direct-chat-warning">
                            ...
                            <div className="direct-chat-contacts">
                                ...
                                <li>
                                    <a href="#">
                                    <img className="contacts-list-img" src="img/user1-128x128.jpg" alt="User Image" />
                                ...
                                <li>
                                    <a href="#">
                                    <img className="contacts-list-img" src="img/user7-128x128.jpg" alt="User Image" />
                                ...
                                <li>
                                    <a href="#">
                                    <img className="contacts-list-img" src="img/user3-128x128.jpg" alt="User Image" />
                                ...
                                <li>
                                    <a href="#">
                                    <img className="contacts-list-img" src="img/user5-128x128.jpg" alt="User Image" />
                                ...
                                <li>
                                    <a href="#">
                                    <img className="contacts-list-img" src="img/user6-128x128.jpg" alt="User Image" />
                                ...
                                <li>
                                    <a href="#">
                                    <img className="contacts-list-img" src="img/user8-128x128.jpg" alt="User Image" />
